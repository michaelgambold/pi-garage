...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Pi Garage

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Pi Garage.
...
- By raising an issue on github: [https://github.com/michaelgambold/pi-garage/issues](https://github.com/michaelgambold/pi-garage/issues)
